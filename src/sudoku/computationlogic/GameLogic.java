...
return false;
    ...
    {
        if(rowsOfSquareIsInvalid(TOP,grid)) return true;
    ...
    public static boolean rowsOfSquareIsInvalid(Rows value, int[][] grid)
    {
    ...
    public static boolean squaresIsInvalid(int xIndex, int yIndex, int[][] grid)
    {
